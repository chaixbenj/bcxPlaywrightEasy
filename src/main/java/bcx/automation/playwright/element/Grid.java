...
import bcx.automation.util.data.DoubleUtil;
...
public class Grid extends BaseElement {
    ...
    public void actionOnRow(int correspondingRow, String action) {
        ...
        this.getTestContext().getReport().log(result, "actionOnRow " + action + COL + correspondingRow, actionButton.getName(), null , null, errorMessage);
    }
    ...
    public void actionOnRow(String subStringInCell, int colNumberSubString, String action) {
        ...
        this.getTestContext().getReport().log(result, "actionOnRow " + action + " sur ligne contenant " + subStringInCell, actionButton.getName(), null , null, errorMessage);
    }
    ...
    public void assertOneRowContains(String[] values, boolean contains) {
        ...
        this.getTestContext().getReport().log(status, action, row.getName(), null, null, null);
    }
    ...
    public void assertRowContainsElement(int rownum, BaseElement element) {
        ...
        this.getTestContext().getReport().log(status, "assertRowContainsElement ", row.getName(), element.getName(), "", null);
    }
    ...
    public void assertRowNotContainsElement(int rownum, BaseElement element) {
        ...
        this.getTestContext().getReport().log(status, "assertRowNotContainsElement ", row.getName(), element.getName(), "", null);
    }
    ...
    public void assertCellContainsElement(int row, int colNumberCellToRead, BaseElement element) {
        ...
        this.getTestContext().getReport().log(status, "assertCellContainsElement ", cell.getName(), element.getName(), "", null);
    }
    ...
    public void assertCellNotContainsElement(int row, int colNumberCellToRead, BaseElement element) {
        ...
        this.getTestContext().getReport().log(status, "assertCellNotContainsElement ", cell.getName(), element.getName(), "", null);
    }
